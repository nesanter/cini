...
struct ini_map_section * ini_map_get_section(struct ini_map_root * map, const char * section);
struct ini_map_section * ini_map_ensure_section(struct ini_map_root * map, const char * section);
char ** ini_map_section_get_value(struct ini_map_section * section, const char * key);
char ** ini_map_section_ensure_value(struct ini_map_section * section, const char * key);

struct ini_map_section * ini_map_first_section(struct ini_map_root * map, char * name);
struct ini_map_section * ini_map_next_section(struct ini_map_root * map, char * name);

char ** ini_map_section_first_value(struct ini_map_section * section, char * key);
char ** ini_map_section_next_value(struct ini_map_section * section, char * key);
